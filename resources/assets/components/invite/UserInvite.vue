<template>
    <div class="user-invite-component">
        <div class="user-invite-component-inner">
                    ...
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div v-if="inviteConfig.message != 'You\'ve been invited to join'">
                            <div class="user-message">
                                <p class="small text-light mb-0">Message from user(s):</p>
...
<script type="text/javascript">
    export default {
        ...
        methods: {
            ...
            verifyToken() {
                axios.post('/api/v1.1/auth/invite/user/verify', {
                    token: this.code,
                })
                .then(res => {
                    this.tabIndex = 1;
            ...
            checkUsernameAvailability() {
                axios.post('/api/v1.1/auth/invite/user/uc', {
                    token: this.code,
            ...
            checkEmailAvailability() {
                axios.post('/api/v1.1/auth/invite/user/ec', {
                    token: this.code,
            ...
            handleRegistration() {
                var $form = $('<form>', {
                    action: '/api/v1.1/auth/invite/user/re',
                    method: 'post'
                });
                let fields = {
